...
extension UIView {
    ...
    @IBInspectable var borderColor: UIColor? {
        get {
            ...
            return ViewBorderColors.shared.uiColors[self]
        }
        set {
            guard let color = newValue else {
                ViewBorderColors.shared.uiColors.removeValue(forKey: self)
    ...
    func dynamicBorderColor(_ color: UIColor?) {
        ViewBorderColors.shared.uiColors[self] = color
        NotificationCenter.default.removeObserver(self, name: .themeChanged, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(updateTheme), name: .themeChanged, object: nil)
    }
    @objc func updateTheme() {
        layer.borderColor = ViewBorderColors.shared.uiColors[self]?.cgColor
    }
...
class ViewBorderColors {
    static let shared = ViewBorderColors()
    var uiColors: [UIView: UIColor] = [:]
}
